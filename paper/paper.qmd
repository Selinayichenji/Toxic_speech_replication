...
Our paper applies using the statistical programming language R (R Core Team 2020). Besides the programming tool, we also employ the following packages: readr (Wickham, Hester, and 
Bryan 2023), broom (找不到), ggplot2 (Wickham H 2016), dplyr (Wickham et al. 2022), tidyverse (Wickham et al. 2019), MetBrewer (找不到), and knitr (Xie 2014).  (unsure about citation)   
